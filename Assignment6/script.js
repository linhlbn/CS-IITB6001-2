...
function toFinnishDiv2() {
    ...
    document.getElementById("home").innerText = "NEXT";
    document.getElementById("finish").innerText = "Confirm your form";
}

function toEnglish(){
    var x1 = document.getElementById("div1");
    if (window.getComputedStyle(x1).visibility==="show") {
        toEnglishDiv1();
    }
}
